...
def run_attack(chat_id, target_ip, port, duration, method, threads, start_msg_id):
    ...
    try:
        ...
        # Send completion message via direct API
        ...
        if start_msg_id:
            success = edit_telegram_message(chat_id, start_msg_id, completion_msg, 'HTML')
            if not success:
                # If edit fails, send new message
                send_telegram_message(chat_id, completion_msg, 'HTML')
        else:
            send_telegram_message(chat_id, completion_msg, 'HTML')
